.. uCore-Tutorial-Guide-2025S documentation master file, created by
...
该指导书为 `THU` `OS` 课程实验 `C` 版实验指导书，旨在帮助同学们快速熟悉框架并完成书面和编程任务, `配套代码 <https://github.com/learningos/ucore-Tutorial-Code-2025S>`_ 。
...
- `该文档仓库 <https://github.com/LearningOS/uCore-Tutorial-Guide-2025S>`_
